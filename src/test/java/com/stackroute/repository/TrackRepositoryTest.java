...
public class TrackRepositoryTest {
    ...
    public void testgetTrackByNameSuccess() {
        trackRepository.save(track);
//        Track trackList=trackRepository.getByName("aadi");
        Assert.assertEquals(track,trackRepository.getByName("aadi"));
    }
    @Test
    public void testgetTrackByNameFailure() {
        trackRepository.save(track);
//        Track trackList=trackRepository.getByName("aadi");
        Assert.assertNotSame(track,trackRepository.getByName("aadii"));
    }
}
